...
import { MapPin, ArrowRight, X, Check, Eye } from 'lucide-react';
              ...
              >
                ...
                <div className="relative h-64 overflow-hidden bg-slate-900">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="bg-[#070D18]/80 backdrop-blur-md border border-white/20 text-amber-400 text-[11px] font-semibold px-3 py-1 rounded-full uppercase tracking-wider">
                      {project.categoryLabel}
                    </span>
                  </div>

                  {/* Location Pin */}
                  <div className="absolute bottom-3 left-4 flex items-center gap-1.5 text-xs text-slate-200 bg-black/50 backdrop-blur-md px-2.5 py-1 rounded-md border border-white/10">
              ...
              >
                ...
                <div className="space-y-6">
                  <div className="relative h-64 rounded-xl overflow-hidden border border-white/10">
                    ...
                    />
                    <div className="absolute top-3 left-3 bg-[#070D18]/80 backdrop-blur-md text-amber-400 text-xs font-semibold px-3 py-1 rounded-full border border-white/20">
